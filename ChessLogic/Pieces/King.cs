...
namespace ChessLogic
{
    public class King : Piece
    {
        ...
        public override IEnumerable<Move> GetMoves(Position from, Board board) 
        {
            ...
            if(CanCastleKingSide(from, board)) yield return new Castling(MoveType.CastleKS, from);
            if (CanCastleQueenSide(from, board)) yield return new Castling(MoveType.CastleQS, from);
        }
